# -*- coding: utf-8 -*-
"""
Created on Tue Oct 12 11:39:42 2021
...
rv = pd.pivot_table(df, values='RE24_change', index='Result', columns='Stadium', aggfunc='mean')
rv = rv.transpose()
...
final = pd.DataFrame(columns=['BB','HBP','Error','Single','Double','Triple','HomeRun'])
for stat in ['BB','HBP','Error','Single','Double','Triple','HomeRun']:
    final[stat] = rrv[stat]/pf[stat]

final.to_csv("C:\\Users\\LIONS\\.spyder-py3\\10월 3주\\구장별 아웃 대비 RV_PF.csv", encoding='cp949')